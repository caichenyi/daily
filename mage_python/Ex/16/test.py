...
if __name__ == '__main__':
    ...
    s = MailClient('smtp.qq.com', 587, '768683868@qq.com', 'gddkybduyccwbbfc')
    # s = MailClient('smtp.yeah.net', 25, 'iamkk88@yeah.net', '51reboot')arktsixjfiqmbfii
    s.set_keepalive(False)
    s.set_debug(True)
    st = time.time()
    s.send('768683868@qq.com', '测试', '测试邮件 From kk')
    print(time.time() - st)